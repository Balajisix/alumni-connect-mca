...
class ProfilePageAlumni extends StatelessWidget {
  const ProfilePageAlumni({Key? key}) : super(key: key);

  Widget _buildViewMode(ProfileProviderAlumni provider, BuildContext context) {
  ...
  Widget _buildEditMode(ProfileProviderAlumni provider, BuildContext context) {
    // Custom blue theme colors
    final Color primaryBlue = Color(0xFF1E88E5);
    final Color lightBlue = Color(0xFFBBDEFB);
    final Color darkBlue = Color(0xFF1565C0);
  ...
  Widget build(BuildContext context) {
    return Consumer<ProfileProviderAlumni>(
