...
class StudentEventListPage extends StatefulWidget {
  const StudentEventListPage({Key? key}) : super(key: key);

  @override
  State<StudentEventListPage> createState() => _StudentEventListPageState();
}

class _StudentEventListPageState extends State<StudentEventListPage> {
  // Define theme colors
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.pushNamed(context, '/student/event/post');
        },
                ...
                builder: (context, eventProvider, child) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _StudentEventCard(event: event);
                    },
                  );
                },
              ),
...
class _StudentEventCard extends StatelessWidget {
  ...
  const _StudentEventCard({required this.event});
